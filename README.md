...
For an end user, the basic flow starts with loading some pretrained models from disk or Internet. Each model comes an identifier, which could be one path on your computer or an URL to any public servers. Here, let's load a tokenizer called `CTB6_CONVSEG` with 2 lines of code.
...
```
Downloading https://file.hankcs.com/hanlp/cws/ctb6-convseg-cws_20191230_184525.zip to /home/ubuntu/.hanlp/cws/ctb6-convseg-cws_20191230_184525.zip
100.00%, 7.4 MB/7.4 MB, 64.1 MB/s, ETA 0 s      
Extracting /home/ubuntu/.hanlp/cws/ctb6-convseg-cws_20191230_184525.zip to /home/ubuntu/.hanlp/cws	
```
...
The NER component requires tokenized tokens as input, and outputs the entities along with their types and span.
...
```bash
$ cat /home/ubuntu/.hanlp/ner/ner_bert_base_msra_20191230_205748/test.log 
...
Epoch 2/100
783/783 [==============================] - 160s 204ms/step - loss: 10.1040 - f1: 0.9037 - val_loss: 8.0666 - val_f1: 0.9254
